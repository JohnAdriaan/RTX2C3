...
namespace ARM::NXP::CCMs::Analogs {
	...
	/// Note that Misc0 serves multiple peripherals. These
	...
	/// Inherit from `Fields0` to implement the main register fields as `misc0.X`,
	/// then have sub-registers to allow the `misc0.set.X` (etc.) paradigm
	struct Misc0 : public Fields0 {
	    Fields0 set;
	    Fields0 clr;
	    Fields0 tog;
	}; // Misc0
	static_assert(sizeof(Misc0)==4*sizeof(unsigned), "Incorrect Misc0 size");

} // namespace ARM::NXP::CCMs::Analogs

static volatile ARM::NXP::CCMs::Analogs::Fields0 &CCM_ANALOG_MISC0     = ARM::NXP::CCMs::Analogs::misc0;
static volatile ARM::NXP::CCMs::Analogs::Fields0 &CCM_ANALOG_MISC0_SET = ARM::NXP::CCMs::Analogs::misc0.set;
static volatile ARM::NXP::CCMs::Analogs::Fields0 &CCM_ANALOG_MISC0_CLR = ARM::NXP::CCMs::Analogs::misc0.clr;
static volatile ARM::NXP::CCMs::Analogs::Fields0 &CCM_ANALOG_MISC0_TOG = ARM::NXP::CCMs::Analogs::misc0.tog;
